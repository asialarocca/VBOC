...
class OCPdoublependulum:
    def __init__(self):
        ...
        #self.ocp.solver_options.nlp_solver_tol_ineq = 1e-5
    ...
    def compute_problem(self, q0, v0):
        ...
        for i in range(self.N + 1):
            self.ocp_solver.set(i, "x", self.ocp.cost.yref_e)
...
class OCPdoublependulumNN(OCPdoublependulum):
    def __init__(self, nn, mean, std):
        ...
        self.ocp.constraints.uh_e = 10*np.array([1.1])
