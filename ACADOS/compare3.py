...
model_dir.load_state_dict(torch.load('model_3pendulum_dir_10_14000'))
data_reverse = np.load('data3_vbocp_10_14000.npy')
...
mean_dir = torch.load('mean_3pendulum_10')
std_dir = torch.load('std_3pendulum_10')

# Active Learning:
model_al = NeuralNet(6, 500, 2).to(device)
model_al.load_state_dict(torch.load('AL/model_3pendulum_10_14000'))
mean_al = torch.load('AL/mean_3pendulum_10')
std_al = torch.load('AL/std_3pendulum_10')
data_al = np.load('AL/data3_al_10_14000.npy')

# RMSE evolutions:
times_al = np.load('AL/times_al3.npy')
rmse_al = np.load('AL/rmse_al3.npy')
times_vbocp = np.load('times_vbocp3.npy')
rmse_vbocp = np.load('rmse_vbocp3.npy')
