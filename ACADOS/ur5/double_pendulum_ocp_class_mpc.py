...
class OCPdoublependulum:
    def __init__(self):
        ...
        # reference
        self.ocp.cost.yref = np.array([-2, -1.5, 0., 0., 0., 0.])
        self.ocp.cost.yref_e = np.array([-2, -1.5, 0., 0.])
        ...
        # self.model.con_h_expr = self.table(self.x)
        # self.ocp.constraints.lh = np.array([0.])
        # self.ocp.constraints.uh = np.array([-0.5])
