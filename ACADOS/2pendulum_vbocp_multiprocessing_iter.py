...
torch.save(mean_dir, 'mean_2pendulum_10')
torch.save(std_dir, 'std_2pendulum_10')
...
np.save('times_vbocp.npy', np.asarray(times))
np.save('rmse_vbocp.npy', np.asarray(rmse))

plt.figure()
plt.plot(times, rmse)

np.save('data2_vbocp_10_1800.npy', np.asarray(X_save))
