...
model_dir.load_state_dict(torch.load('model_2pendulum_dir_10_1800'))
data_reverse = np.load('data2_vbocp_10_1800.npy')
...
mean_dir = torch.load('mean_2pendulum_10')
std_dir = torch.load('std_2pendulum_10')

# Active Learning:
model_al = NeuralNet(4, 300, 2).to(device)
model_al.load_state_dict(torch.load('AL/model_2pendulum_al_10_1800'))
mean_al = torch.load('AL/mean_2pendulum_10')
std_al = torch.load('AL/std_2pendulum_10')
data_al = np.load('AL/data2_al_10_1800.npy')

# HJ Reachability:
model_hjr = NeuralNet(4, 100, 2).to(device)
model_hjr.load_state_dict(torch.load('HJR/model_2pendulum_hjr_10_1800'))
mean_hjr = torch.load('HJR/mean_2pendulum_10')
std_hjr = torch.load('HJR/std_2pendulum_10')

# RMSE evolutions:
times_hjr = np.load('HJR/times_hjr.npy')
rmse_hjr = np.load('HJR/rmse_hjr.npy')
times_al = np.load('AL/times_al.npy')
rmse_al = np.load('AL/rmse_al.npy')
times_vbocp = np.load('times_vbocp.npy')
rmse_vbocp = np.load('rmse_vbocp.npy')
...
with torch.no_grad():
    ...
    print('RMSE train data wrt VBOCP NN: ', torch.sqrt(criterion_dir(model_dir(X_iter_tensor), y_iter_tensor)))
