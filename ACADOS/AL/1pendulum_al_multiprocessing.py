...
with cProfile.Profile() as pr:
    ...
    np.save('data1_al_10.npy', np.asarray(X_iter))
    torch.save(model.state_dict(), 'model_1pendulum_al_10')
    torch.save(mean, 'mean_1pendulum_al_10')
    torch.save(std, 'std_1pendulum_al_10')
