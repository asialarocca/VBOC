...
class OCPdoublependulum:
    def __init__(self):
        ...
        # reference
        self.ocp.cost.yref = np.array([-0.7805794638446351, -2.05, 0., 0., 0., 0.])
        self.ocp.cost.yref_e = np.array([-0.7805794638446351, -2.05, 0., 0.])
        ...
        self.ocp.solver_options.eps_sufficient_descent = 1e-4
        # self.ocp.solver_options.alpha_reduction = 0.3
        # self.ocp.solver_options.alpha_min = 1e-5
...
class OCPdoublependulumNN(OCPdoublependulum):
    def __init__(self, nn, mean, std):
        ...
        self.ocp.constraints.uh_e = 100*np.array([1.1])
        ...
        for param in nn.parameters():
            ...
            if it % 2 == 0:
                ...
                if it == 3:
                    ...
                    out = 1 / (1 + exp(-out))
                    return 100*vertcat(out[1]-out[0])
