...
/* pendulum_ode_expl_ode_fun:(i0[2],i1,i2[])->(o0[2]) */
static int casadi_f0(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem) {
  casadi_real a0, a1;
  a0=arg[0]? arg[0][1] : 0;
  if (res[0]!=0) res[0][0]=a0;
  a0=1.4715000000000000e+00;
  a1=arg[0]? arg[0][0] : 0;
  a1=sin(a1);
  a0=(a0*a1);
  a1=arg[1]? arg[1][0] : 0;
  a0=(a0+a1);
  a1=4.4999999999999998e-02;
  a0=(a0/a1);
...
CASADI_SYMBOL_EXPORT int pendulum_ode_expl_ode_fun_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int pendulum_ode_expl_ode_fun_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void pendulum_ode_expl_ode_fun_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int pendulum_ode_expl_ode_fun_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void pendulum_ode_expl_ode_fun_release(int mem) {
}
...
CASADI_SYMBOL_EXPORT casadi_int pendulum_ode_expl_ode_fun_n_in(void) { return 3;}

CASADI_SYMBOL_EXPORT casadi_int pendulum_ode_expl_ode_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real pendulum_ode_expl_ode_fun_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}
