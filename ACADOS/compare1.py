...
model_dir.load_state_dict(torch.load('model_1pendulum_dir_10'))
data_reverse = np.load('data1_vbocp_10.npy')
...
mean_al = torch.load('AL/mean_1pendulum_al_10')
std_al = torch.load('AL/std_1pendulum_al_10')
data_al = np.load('AL/data1_al_10.npy')

# HJ Reachability:
model_hjr = NeuralNet(2, 100, 2).to(device)
model_hjr.load_state_dict(torch.load('HJR/model_1pendulum_hjr_10'))
mean_hjr = torch.load('HJR/mean_1pendulum_hjr_10')
std_hjr = torch.load('HJR/std_1pendulum_hjr_10')
