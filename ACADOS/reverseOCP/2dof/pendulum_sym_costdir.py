...
if __name__ == "__main__":
    ...
    ocp.model.cost_expr_ext_cost = 0. # weight * dtheta
    ...
    for i, tau in enumerate(np.linspace(0, 1, N)):
        ...
        ocp_solver.constraints_set(i, 'lbx', np.array([thetamin, 0.])) 
        ocp_solver.constraints_set(i, 'ubx', np.array([thetamax, dthetamax])) 

    ocp_solver.constraints_set(N, "lbx", np.array([thetamax, 0.]))
    ocp_solver.constraints_set(N, "ubx", np.array([thetamax, 0.]))

    ocp_solver.set(N, 'x', np.array([thetamax, 0.]))
    ocp_solver.set(N, 'p', np.array([-1.]))

    ocp_solver.constraints_set(0, "lbx", np.array([thetamin, 0.]))
    ocp_solver.constraints_set(0, "ubx", np.array([thetamax, dthetamax]))
    ...
    for i, tau in enumerate(np.linspace(0, 1, N)):
        ...
        ocp_solver.set(i, 'x', x_guess)
        ocp_solver.set(i, 'p', np.array([1.]))
        ocp_solver.constraints_set(i, 'lbx', np.array([thetamin, -dthetamax])) 
        ocp_solver.constraints_set(i, 'ubx', np.array([thetamax, 0.])) 

    ocp_solver.constraints_set(N, "lbx", np.array([thetamin, 0.]))
    ocp_solver.constraints_set(N, "ubx", np.array([thetamin, 0.]))

    ocp_solver.set(N, 'x', np.array([thetamin, 0.]))
    ocp_solver.set(N, 'p', np.array([1.]))

    ocp_solver.constraints_set(0, "lbx", np.array([thetamin, -dthetamax]))
    ocp_solver.constraints_set(0, "ubx", np.array([thetamax, 0.]))
