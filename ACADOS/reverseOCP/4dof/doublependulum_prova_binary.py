        ...
        if status == 0:
            ...
            if status == 0:
                ...
                if it >= 0:
                    ...
                    ocp.ocp_solver.constraints_set(0, 'lbx', np.array([x0[0], x0[1], x0[2], x0[3], 1.])) 
                    ocp.ocp_solver.constraints_set(0, 'ubx', np.array([x0[0], x0[1], x0[2], x0[3], 1.])) 
                    ocp.ocp_solver.set(0, 'p', p_mintime)
                    
                    dt_sym_max = ocp.ocp_solver.get(0, "x")[4]
                    print(dt_sym_max)

                    x_guess = np.empty((ocp.N+1,5))
                    u_guess = np.empty((ocp.N,2))

                    for i in range(0, ocp.N):
                        prev_sol = ocp.ocp_solver.get(i, "x")
                    ...
                    ocp.ocp_solver.set_new_time_steps(np.full((ocp.N,), dt_sym_max - 1e-6))
                    ...
                    ocp.ocp_solver.set(ocp.N, 'x', x_guess[i])
