...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        model_al.load_state_dict(torch.load('model_2pendulum_15'))
    ...
    #         x_guess = np.array([(1-tau)*q_min + tau*q_max, q_fin, 2*(1-tau)*(q_max-q_min), 0., 1e-2]) # v_max
    ...
    #     ocp.ocp_solver.constraints_set(0, "lbx", np.array([q_min, q_min, 0., v_min, 1e-2]))
    #     ocp.ocp_solver.constraints_set(0, "ubx", np.array([q_min, q_max, v_max, v_max, 1e-2]))
    ...
    #     ocp.ocp_solver.constraints_set(0, "lbx", np.array([q_max, q_min, v_min, v_min, 1e-2]))
    #     ocp.ocp_solver.constraints_set(0, "ubx", np.array([q_max, q_max, 0., v_max, 1e-2]))
    ...
    #     ocp.ocp_solver.constraints_set(0, "lbx", np.array([q_min, q_min, v_min, 0., 1e-2]))
    #     ocp.ocp_solver.constraints_set(0, "ubx", np.array([q_max, q_min, v_max, v_max, 1e-2]))
    ...
    #     ocp.ocp_solver.constraints_set(0, "lbx", np.array([q_min, q_max, v_min, v_min, 1e-2]))
    #     ocp.ocp_solver.constraints_set(0, "ubx", np.array([q_max, q_max, v_max, 0., 1e-2]))
    ...
    # # np.save('data_reverse_750000.npy', np.asarray(X_save))

    X_save = np.load('data_reverse_100.npy')
    ...
    while val > loss_stop:
        ...
        if it >= it_max and val > val_prev - 1e-2:
            break
