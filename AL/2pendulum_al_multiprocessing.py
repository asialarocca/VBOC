...
with cProfile.Profile() as pr:
    ...
    torch.save(mean, 'mean_2dof_al_10')
    torch.save(std, 'std_2dof_al_10')
    ...
    torch.save(model.state_dict(), 'model_2dof_al_10_1800s')
    np.save('data_2dof_al_10_1800s.npy', np.asarray(X_iter))
