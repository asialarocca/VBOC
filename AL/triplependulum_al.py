...
with cProfile.Profile() as pr:
    ...
    N_init = pow(6, ocp_dim)  # size of initial labeled set
    B = pow(6, ocp_dim)  # batch size
    ...
    torch.save(mean, 'mean_3dof_al')
    torch.save(std, 'std_3dof_al')
    ...
    torch.save(model.state_dict(), 'model_3dof')
    np.save('data_3dof_al.npy', np.asarray(X_iter))
