...
from casadi import SX, vertcat, cos, sin, fmax
import math
...
class OCPtriplependulum:
    def __init__(self, mean, std, params):
        ...
        self.ocp.constraints.lbx_0 = np.array([self.thetamin, self.thetamin, self.thetamin, -self.dthetamax, -self.dthetamax, -self.dthetamax]) 
        self.ocp.constraints.ubx_0 = np.array([self.thetamax, self.thetamax, self.thetamax, self.dthetamax, self.dthetamax, self.dthetamax]) 
