...
eps = 1e-2 # unviable data generation parameter

tol = 1e-3 # OCP cost tolerance
...
torch.save(mean_dir, 'mean_3dof_vboc_10')
torch.save(std_dir, 'std_3dof_vboc_10')
...
np.save('data_3dof_vboc_10_14400s.npy', np.asarray(X_save))
torch.save(model_dir.state_dict(), 'model_3dof_vboc_10_14400s')
