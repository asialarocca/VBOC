...
stop_time = 1800 # total computational time
...
torch.save(mean_dir, 'mean_2dof_vboc_10')
torch.save(std_dir, 'std_2dof_vboc_10')
...
np.save('data_2dof_vboc_10_1800s.npy', np.asarray(X_save))
torch.save(model_dir.state_dict(), 'model_2dof_vboc_10_1800s.npy')
